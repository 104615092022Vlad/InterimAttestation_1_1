...
public class Message {
    ...
    public static int getMessageLength() {
        ...
        int messageLength = 62 * lettersQuantity / 3 + 12 * spacesQuantity;
        ...
        try {
            ...
            if (lengthFence >= 0) {
                if (lengthFence >= messageLength ) {
                    System.out.println(messageLength + "Надпись поместится");
                } else {
                    System.out.println(messageLength + "Надпись не поместится");
                }
                trigger = false;
            } else {
